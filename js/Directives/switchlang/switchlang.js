...
define([
    ...
    'app',
        ...
        app.directive('switchlang', ['$rootScope',function ($rootScope) {
            return {
                restrict: 'E',
                scope: false,
                replace: true,
                ...
                controller: ['$q', '$scope', '$rootScope', 'InitConfig', 'luiDialog', '$translate', 'mzAPI', '$state', function ($q, $scope, $rootScope, InitConfig, luiDialog, $translate, mzAPI, $state) { 
                    $scope.api = mzAPI; 
                    ...
                    $scope.activeLang = function (item) {
                        if (!item.active) { 
                            ...
                            if(currentState == 'App.Favoritos.View.Dashboard'){                                
                                $rootScope.$broadcast('reloadFavoritos');
                            }
                            if(currentState == 'App.Visualizaciones.View.Visualizaciones'){                                
                                $rootScope.$broadcast('reloadVisualizaciones');
                            }
                        }
                    }                                        
                }]
