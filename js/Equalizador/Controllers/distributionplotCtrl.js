...
define([
    ...
    app.controller('distributionplotCtrl', ['$scope', '$rootScope', '$q', '$translate', 'orderByFilter', function ($scope, $rootScope, $q, $translate, orderBy) {
        ...
        $scope.app.model.engineApp.getObject(
            ...
            qBook.getEffectiveProperties().then(function (res) {
                ...
                function getValue() {
                    return new Promise(resolve => {
                        $scope.app.model.engineApp.getObject(
                            ...
                            qBook.getEffectiveProperties().then(function (res) {
                                resolve(res.qUndoExclude.qHyperCubeDef.qDimensions[0].qDef.qSortCriterias[0]);
                            })
                        })
                    })
                }
                    ...
                    return new Promise(resolve => {
                        $scope.app.model.engineApp.getObject(
                            ...
                            qBook.getEffectiveProperties().then(function (res) {
                                ...
                                var dimensionCriterias = _propiedades.qUndoExclude.qHyperCubeDef.qDimensions[0].qDef.qSortCriterias[0];
                                $scope.dimensionCriterias = dimensionCriterias;
                                var _sortingBy = '';
                                var _sortingStr = '';
                                var orderBy = '';
                                if (dimensionCriterias.hasOwnProperty('qExpression') && dimensionCriterias.qSortByExpression !== 0) {
                                    _sortingBy = "sortByExpression";
                                    orderBy = dimensionCriterias.qSortByExpression;
                    ...
                    if (sortingBy == text) {
                        qBook.getEffectiveProperties().then(function (i) {
                            ...
                            if (_autoSort == true) {
                                ...
                                _patches = [
                                    {
                                        "qPath": "/sorting/sortCriteria/" + sortingStr + "",
                                        "qOp": "replace",
                ...
                function getOrientacion() {
                    var defer = $q.defer();
                    $scope.orientacion = _model.orientation;
                ...
                function getTamañoBurbujas() {
                    $scope.BubbleSizes = _model.dataPoint.bubbleScales;
                    $("#slider-range").slider({
                        range: false,
                ...
                function getPuntosFluctuacion() {
                    $scope.showPuntosFluctuacion = _model.dataPoint.displacement;
                ...
                function getColor() {
                    $scope.checkColor;
                    $scope.colorBurbuja = _model.color.point.mode;
                    $scope.modoColor = _model.color.point.auto;
                ...
                function getLeyendas() {
                    $scope.checkboxLeyendas = _model.legend.show;
                ...
                function getPosicionLeyenda() {
                    $scope.posicionLeyenda = _model.legend.dock;
                }
                ...
                function colorTipo() {
                    var defer = $q.defer();
                    var _dato = _model.color.point.dimensionScheme;
                    defer.resolve(_dato);
                    return defer.promise;
                }

                function getPersistentColors() {
                    colorTipo().then(function (i) {
                        $scope.persistentColors = i;
                        $scope.value = _model.color.point.dimensionScheme;
                ...
                function colorModo() {
                    var defer = $q.defer();
                    var _modo = _model.color.useDimColVal;
                    defer.resolve(_modo);
                    return defer.promise;
                }
