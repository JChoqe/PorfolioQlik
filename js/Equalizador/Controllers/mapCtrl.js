...
define([
    ...
    app.controller('mapCtrl', ['$scope', '$rootScope', '$q', '$translate', function ($scope, $rootScope, $q, $translate) {
                ...
                function getlayersMapa() {
                    layersMapa().then(function (result) {
                        result.forEach(function (value, i) {
                            var capa = {};
                            capa.template = 'js/Equalizador/partials/mapPartials/' + value.type + '.html';
                            capa.orden = i;
