...
define([
    ...
    app.controller('treemapCtrl', ['$scope', '$rootScope', '$q', '$translate', 'orderByFilter', function ($scope, $rootScope, $q, $translate, orderBy) {
        ...
        $translate.onReady(function () {
            ...
            $scope.personalizado = $translate.instant('equalizer.label.personalizado');
        });
        ...
        $scope.app.model.engineApp.getObject(
            ...
            qBook.getEffectiveProperties().then(function (res) {
                ...
                function LabelsSettingsConfi() {
                    ...
                    var arrayLabelsSettings = _propiedades.labels;
                    defer.resolve(arrayLabelsSettings);
                    return defer.promise;
                }

                function getLabelsSettingsConfi() {
